...
export const TURKEY_CITIES: City[] = [
  ...
  { name: "Eskişehir", districts: ["Alpu", "Beylikova", "Çifteler", "Günyüzü", "Han", "İnönü", "Mahmudiye", "Odunpazarı", "Sarıcakaya", "Seyitgazi", "Sivrihisar", "Tepebaşı", "Mihalgazi", "Mihalıççık"] },
  ...
  { name: "Kahramanmaraş", districts: ["Afşin", "Andırın", "Dulkadiroğlu", "Ekinözü", "Elbistan", "Göksun", "Nurhak", "Onikişubat", "Pazarcık", "Türkoğlu", "Çağlayancerit"] },
...
// İlleri ve ilçeleri alfabetik olarak sıralıyoruz (Türkçe karakterlere duyarlı)
TURKEY_CITIES.sort((a, b) => a.name.localeCompare(b.name, "tr"));
TURKEY_CITIES.forEach(city => {
  city.districts.sort((a, b) => a.localeCompare(b, "tr"));
});

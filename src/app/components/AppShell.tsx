  ...
  useEffect(() => {
    ...
    switch (true) {
      ...
      case subPath === "/appointments":
        ...
        setHeaderSubtitle(
          "Randevuları tarih ve hekim bazlı olarak görüntüleyin ve boşluklarınızı görün."
        );
        break;
      ...
      case pathname === "/platform/clinics/activity":
        ...
        setHeaderSubtitle(
          "Yeni kayıtlar, abonelik durumları ve sistem genelindeki kritik olayları takip edin."
        );
        break;
      case pathname === "/platform/clinics":
        setHeaderTitle("Sistem Ayarları");
        setHeaderSubtitle(
          "Fiyatlandırma, deneme süresi ve global platform ayarlarını yönetin."
        );
        break;

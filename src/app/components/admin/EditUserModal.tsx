                        ...
                        {(isDoctor || isClinicalProvider) && (
                            <div className="space-y-2 group">
                                <div className="flex items-center gap-2">
                                    ...
                                    <label className="block text-[11px] font-black text-slate-500 uppercase tracking-widest px-1">Uzmanlık Alanı</label>
                                </div>
                                <div className="relative">
                                    <input
                                        type="text"
                                        ...
                                        className="w-full rounded-2xl border-slate-200 bg-slate-50/50 px-4 py-3 text-sm font-semibold text-slate-900 outline-none transition-all focus:bg-white focus:ring-4 focus:ring-teal-500/10 focus:border-teal-500 placeholder:text-slate-400"
                                        placeholder="ör. İmplantoloji, Ortodonti..."
                                    />

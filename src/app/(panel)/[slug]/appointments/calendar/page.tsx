    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        <div className="flex flex-wrap gap-3">
          ...
          <span className="inline-flex items-center gap-1.5 rounded-full bg-amber-50 border border-amber-200 px-3 py-1.5 text-[11px] font-semibold text-amber-700">
            <span className="h-1.5 w-1.5 rounded-full bg-amber-500" />
            Onay bekliyor
          </span>
          <span className="inline-flex items-center gap-1.5 rounded-full bg-blue-50 border border-blue-200 px-3 py-1.5 text-[11px] font-semibold text-blue-700">
            <span className="h-1.5 w-1.5 rounded-full bg-blue-500" />
            Tamamlandı
          </span>
          <span className="inline-flex items-center gap-1.5 rounded-full bg-rose-50 border border-rose-200 px-3 py-1.5 text-[11px] font-semibold text-rose-700">
        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          />
          <button
            className="rounded-xl border border-slate-200 bg-white px-4 py-2.5 text-xs font-medium text-slate-600 shadow-sm hover:bg-slate-50 hover:border-slate-300 transition-all"
            onClick={() => setSelectedDate(today)}
          >
            Bugün
          </button>
          <button
            className="rounded-xl bg-gradient-to-r from-indigo-600 to-violet-500 px-4 py-2.5 text-xs font-semibold text-white shadow-md hover:from-indigo-700 hover:to-violet-600 transition-all flex items-center gap-1.5 disabled:opacity-50"

...
function KpiCard({ label, value, sub, color, style }: { label: string; value: string; sub?: string; color?: string; style?: React.CSSProperties }) {
    return (
        <div className={`rounded-3xl border p-6 flex flex-col gap-1 transition-all ${color || ""}`} style={style}>
                ...
                <tbody className="divide-y divide-slate-50">
                    {rows.map(r => (
                        <tr key={r.doctorId} className="hover:bg-slate-50 transition-colors">
                            ...
                            <td className="py-3 px-4 font-semibold" style={{ color: (useClinic().themeColorFrom || '#4f46e5') }}>{fmt(r.doctorPrim)}</td>
                                    ...
                                    <div className="flex items-center gap-2">
                                        <div className="flex-1 h-1.5 bg-slate-100 rounded-full overflow-hidden">
                                            <div
                                                ...
                                                style={{ width: `${pct}%`, background: (useClinic().themeColorFrom || '#0d9488') }}
                                            />
                                        </div>
...
export default function FinancePage() {
    ...
    const { userRole, themeColorFrom: brandFrom = '#0d9488' } = clinic;
                    ...
                    {QUICK_RANGES.map(r => {
                        ...
                        return (
                            <button
                                ...
                                style={isActive ? { background: brandFrom, borderColor: brandFrom } : {}}
                            >
                                {r.label}
                            </button>
                        );
                ...
                <>
                    ...
                    <div className="grid grid-cols-2 lg:grid-cols-5 gap-4">
                        <KpiCard
                            ...
                            style={{ background: `${brandFrom}08`, borderColor: `${brandFrom}15`, color: brandFrom }}
                        />
                        <KpiCard
                        ...
                        <KpiCard
                            ...
                            sub="Prim % × Tahsilat"
                            style={{ background: `${brandFrom}15`, borderColor: `${brandFrom}25`, color: brandFrom }}
                        />
                        <KpiCard
